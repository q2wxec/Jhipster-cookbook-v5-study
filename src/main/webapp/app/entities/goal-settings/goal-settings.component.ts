...
export class GoalSettingsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.goalSettingsService
                ...
                .subscribe(
                    (res: HttpResponse<IGoalSettings[]>) => this.paginateGoalSettings(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInGoalSettings();
    }
    ...
    trackId(index: number, item: IGoalSettings) {
        return item.id;
    }

    registerChangeInGoalSettings() {
        this.eventSubscriber = this.eventManager.subscribe('goalSettingsListModification', response => this.loadAll());
    }
    ...
    protected paginateGoalSettings(data: IGoalSettings[], headers: HttpHeaders) {
