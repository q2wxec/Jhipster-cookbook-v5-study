...
import { GoalSettingsComponent } from 'app/entities/goal-settings/goal-settings.component';
...
describe('Component Tests', () => {
    describe('GoalSettings Management Component', () => {
        let comp: GoalSettingsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GoalSettingsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.goalSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
